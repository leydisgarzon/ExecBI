...
<html>
    <head>
        ...
        <spring:url value="/resources/core/js/addOfficeJS.js" var="jsManager"/>
            ...
            <f:form role="form" method="post" commandName="office"  class="form-horizontal" id="addOffice-form">
                <fieldset><legend>Office Manager Data</legend>
                            <div class="form-group form-group-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <f:input path="office.id" type="text" class="form-control" id="office"/>
                                    </div>
                            </div>
                    ...
                    <div class="form-group form-group-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <f:select path="manager.id" items="${employees}" class="form-control" id="mgList" itemValue="id" itemLabel="name"  />
                                    </div>
                    </div>
                    <div class="form-group form-group-lg">
